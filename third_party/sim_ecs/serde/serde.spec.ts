...
export const C_ID_MARKER = "#ID";
export const C_MARKER_SEPARATOR = "|";
export const C_REF_MARKER = "*****";
export const C_RESOURCE_MARKER = "#RES";
export const C_RESOURCE_MARKER_VALUE = 1;
export const C_TAG_MARKER = "#TAGS";
